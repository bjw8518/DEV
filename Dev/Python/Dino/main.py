...
# name = Text(root, width=20, height=1)
ent = Entry(root)
ent.pack()
...
btn1 = Button(root, text="게임입장",command=onclick)
btn1.pack()
...
label2 = Label(root,text="점수")
label2.pack()

label3 = Label(root,text=score)
label3.pack()
...
btn1 = Button(root, text="점수보기",command=onclick)
btn1.pack()
